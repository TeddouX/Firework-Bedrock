...
public:
    ...
    auto send(const std::vector<std::uint8_t> &data, const Address &addrInfo) -> bool override;
    auto send_all(const std::vector<std::vector<std::uint8_t>> &data, const Address &addrInfo) -> bool override;
